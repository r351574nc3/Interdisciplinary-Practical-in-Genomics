...
\newenvironment{s5presentation}{\endpar%
  ...
  <div class="content">
    <div class="content_l">
      <div class="content_r">
        <img src="ui/default/blank.gif" id="filler" border="0"/>
<div class="layout">
  <div id="controls"><!-- DO NOT EDIT --></div>
  <div id="currentSlide"><!-- DO NOT EDIT --></div>
  <div id="header">
    <img style="position: relative; top:30px; left: 18px;" id="logo" src="ui/default/logo.png" />
  </div>
  <div id="footer">
    <div class="footer_l">
      <div class="footer_r">
...
\xml{a href="#1" id="external" rel="lightbox[gallery]"}\xml{img src="#2" id="external" border="0" width="150"/}\xml{/a}
}
