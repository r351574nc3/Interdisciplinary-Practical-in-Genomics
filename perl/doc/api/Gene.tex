\section{Class \texttt{Gene}\label{Class_Gene}\index{Class Gene}}
...
\subsection*{Method \texttt{equals}\label{Method_equals}\index{Method equals}}
...
\subsection*{Method \texttt{isAdjacentTo}\label{Method_isAdjacentTo}\index{Method isAdjacentTo}}
...
\subsection*{Getter/Setter \texttt{record}\label{Getter_Setter_record}\index{Getter/Setter record}}


Getter/Setter for the \texttt{BlastRecord} of an \texttt{Gene}
